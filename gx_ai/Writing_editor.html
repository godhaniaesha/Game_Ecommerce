          ...
          <div class="pl-48px">
            ...
            <div class="relative">
              ...
              <div id="model-dropdown"
                ...
                <div
                  class="option flex justify-between items-center px-5 py-2 cursor-pointer hover:bg-[var(--dropdown-hover)] selected"
                ...
                <div class="px-5 pb-3 justify-center flex items-center">
                  <div class="cursor-pointer">
                    <div class="flex justify-between items-center">
                      <span class="text-xs font-semibold" style="color: var(--dropdown-text);">Upgrade
                        to Google AI
                        Pro</span>
                    </div>
                  ...
                  <div class="pl-5">
                    <a href="Upgrad.html" class="h-9 rounded-full justify-center flex items-center text-sm  w-[100px]"
            ...
            <div class="max-w-3xl mx-auto w-full">
              ...
              <div class="flex flex-wrap sm:flex-nowrap items-start sm:items-center gap-4 mb-6">
                <div class="w-16 h-16 rounded-full flex items-center justify-center shrink-0"
                  ...
                  <i class="ph ph-pencil-circle text-4xl" style="color: var(--icon-color);"></i>
                </div>
                <div>
