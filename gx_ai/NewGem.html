            ...
            <div class="main-chat-area">
                <div class="chat-content-wrapper" style="background-color: var(--bg-main);">
                    <div class=" newGems-add-container flex p-10 gap-5 w-[100%] justify-center main-container">
                        ...
                        <form id="myGemsForm" action="" onsubmit=""
                            ...
                            <div class="w-[100%] flex mt-5 gap-5 flex-col lg:flex-row">
                                <div id="editorSection" class="editor-section flex gap-5 flex-col w-full lg:w-[50%]">
                                    ...
                                    <div class="flex flex-col mt-5 w-full space-y-1">
                                        <div class="flex items-center relative">
                                            ...
                                            <div id="infoIcon"
                                                ...
                                                <div id="tooltip"
                                                    class="absolute bottom-12 left-0 w-72 text-sm rounded-lg shadow-lg p-4 z-50 hidden"
                                                    ...
                                                    <div class="flex justify-start gap-4 font-semibold"
                                                        ...
                                                        <button type="button" class="hover:underline">Learn more</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-col w-full space-y-1">
                                        <div class="flex items-center relative">
                                            <label class="text-md font-semibold mr-2"
                                                style="color: var(--text-color);">Knowledge</label>
                                            <div id="knowledgeIcon"
                                                class="rounded-full hover:bg-[var(--icon-hover-bg)] w-9 h-9 flex items-center justify-center cursor-pointer relative"
                                                style="color: var(--text-color)">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="20px"
                                                    viewBox="0 -960 960 960" width="20px" fill="currentColor">
                                                    <path
                                                ...
                                                <div id="knowledgeTooltip"
                                                    class="absolute bottom-12 left-0 w-72 text-sm rounded-lg shadow-xl p-4 z-50 hidden"
                                                    style="background-color: var(--tooltip-bg); color: var(--tooltip-text);">
                                                    <div class="mb-2">Add up to 10 files for your Gem to reference
                                                        in
                                                        chats. You can
                                                        delete files at any time from here.</div>
                                                    <div class="flex justify-start gap-4 font-semibold"
                                                        style="color: var(--tooltip-button-text);">
                                                        <button type="button" class="hover:underline">Got it</button>
                                                        <button type="button" class="hover:underline">Learn more</button>
                                        ...
                                        <div class="relative">
                                            <div class="flex items-center justify-between w-full p-4 rounded-md"
                                                style="background-color: var(--input-bg); focus-within:border-var(--input-border-focus)">
                                                <div id="fileText" class="select-none cursor-default"
                                                    style="color: var(--placeholder-color);">
                                                    Add files for your Gem to reference
                                                </div>
                                                <div id="imageWrapper" class="relative hidden group">
                                                    <img id="previewImage" class="h-24 w-24 object-cover rounded-md"
                                                        alt="Preview" />
                                                    <button id="removeImage" 
                                                        class="absolute top-1 right-1 bg-black bg-opacity-60 text-white rounded-full w-8 h-8 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                                                        type="button">
                                                        ×
                                                    </button>
                                                </div>
                                                <button id="toggleDropdown"
                                                    class="w-8 h-8 rounded-full flex items-center justify-center text-3xl"
                                                    style="color: var(--text-color);" type="button">
                                                    +
                                                </button>
                                            </div>
                                            <div id="dropdownMenuknowlage"
                                                class="absolute bottom-full mb-2 right-0 w-56 rounded-xl shadow-lg py-2 z-50 hidden"
                                                style="background-color: var(--dropdown-bg); color: var(--text-color);">
                                                <div id="uploadOption"
                                                    ...
                                                    <span class="pl-2">Upload files</span>
                                                </div>
                                                <div class="flex items-center gap-2 p-2 cursor-pointer"
                                                    ...
                                                    <span class="pl-2">Add from Drive</span>
                                                </div>
                                            </div>
                                ...
                                <div id="previewSection"
                                    ...
                                    <div  class="w-full p-6 relative rounded-lg shadow h-full overflow-hidden"
                                        ...
                                        <div id="previewSectionChat" class="w-full h-full absolute top-0 left-0 z-1 opacity-[0.5]"></div>
                                        <div id="previewBox"
                                            ...
                                            <div  class="rounded-full  w-[50px] h-[50px] flex items-center justify-center mb-10"
                                                style="background-color: var(--icon-hover-bg); ">
                                                <span id="gem-preview-Name" class="material-symbols-outlined text-[30px] text-white flex items-center text-center justify-center w-full h-full" 
